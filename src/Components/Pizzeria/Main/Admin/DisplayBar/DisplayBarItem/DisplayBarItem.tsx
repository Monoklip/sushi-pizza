            ...
            {displayDelete &&
                <div className='display-bar-item'>
                    ...
                    <div className="display-bar-item-buy">
                        <button className="display-bar-item-buy-btnDelete" onClick={deleteBtn}>Удалити</button>
                        <button className="display-bar-item-buy-btnRename" onClick={renameBtn}>Редагувати</button>
                    </div>
                </div>
            }
            {displayRename && 
                <div className='display-bar-item-rename'>
                    <h1>Редагування</h1>
                    <p>Введіть назву</p>
