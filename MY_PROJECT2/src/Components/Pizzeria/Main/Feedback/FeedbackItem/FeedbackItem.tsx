            ...
            {props.elem.check === 'good' &&
                <>
                    ...
                    <div className="feedbackItem-user">
                        <div className="feedbackItem-user-name" style={{fontWeight: 'bold', color: `green`}}>{props.elem.name}</div>
                        <div className="feedbackItem-user-comment">{props.elem.text}</div>
                    </div>
                </>
            }
             {props.elem.check === 'bad' &&
                <>
                    ...
                    <div className="feedbackItem-user">
                        <div className="feedbackItem-user-name" style={{fontWeight: 'bold', color: `red`}}>{props.elem.name}</div>
                        <div className="feedbackItem-user-comment">{props.elem.text}</div>
                    </div>
                </>
            }
             {props.elem.check === 'none' &&
                <>
                    ...
                    <div className="feedbackItem-user">
                        <div className="feedbackItem-user-name" style={{fontWeight: 'bold', color: `blue`}}>{props.elem.name}</div>
                        <div className="feedbackItem-user-comment">{props.elem.text}</div>
                    </div>
                </>
            }
